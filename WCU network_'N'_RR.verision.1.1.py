# -*- coding: utf-8 -*-
"""
Created on Wed Jan 27 17:23:04 2021
...
valves_remove=[]
valves_remove= random.sample(valves, 80)
scenarios=[]
listing_valve=[]
scenarios.append(valves_remove)

valves_remain = [x for x in valves if x not in valves_remove]

for listing in scenarios:
    
    for R in range(0, len(listing)):
        M_gh=nx.contracted_edge(seg_valve, listing[R])
