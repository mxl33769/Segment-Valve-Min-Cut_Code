# -*- coding: utf-8 -*-
"""
Created on Wed Jan 13 13:41:42 2021
...
seg_valve.add_node(66)

seg_valve.add_edge(66, 65)

seg_valve.add_edge(66, 39)
...
for i in nodes:  
   connectivity_dict[i]=local_node_connectivity(seg_valve, 66, i)
##############################################################################
...
for i in nodes:
    S_cut_K[i]=nx.minimum_node_cut(seg_valve, 66, i)
